...
This guide will simply explain how to operate the IIR robot. Following this guide will start NAV2, allowing the user to select a point on the map, which the robot will navigate to.  

If you are looking for more in depth understanding of how the software on the IIR robot works, go to [IIR Software Documentation]
